              ...
              <div class="card card-statistic-2" style="margin-top: 60px;">
                ...
                <div class="card-wrap">
                  <div class="card-header  mt-2">
                    <h6 style="font-size: 30px;">Baju Adat</h6>
                  </div>
                </div>
              </div>
               <?php echo $this->session->flashdata('pesan') ?>
                          <div class="row row1" >
                            <?php foreach ($baju_adat as $bj) : ?>

                              <div class="col-sm-3 col1 text-center">
                                <div class="card card1" >
                                  <img src="<?php echo base_url().'/uploads/'.$bj->foto ?>" class="" alt="..." style="width: 100%; height: 100%; ">
                                  <div class="card-body card-body1">
                                    <h5 class="card-title mb-1 card-title1"><font face="Segoe UI" size="3" color="black"><?php echo $bj->nama_baju ?></font></h5>
                                <small style="font-size: 12px"><?php echo $bj->nama_kategori ?></small><br>
                              <span class="badge badge-success mb-2 badge1">Rp. <?php echo number_format($bj->harga,0,',','.')  ?> </span>
                              <br>
