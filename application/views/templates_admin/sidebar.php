      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">              
              ...
              <li><a class="nav-link" href="<?php echo base_url('admin/data_baju') ?>"><i class="fas fa-tshirt"></i> <span>Data Baju</span></a></li>

              <li><a class="nav-link" href="<?php echo base_url('admin/data_kategori') ?>"><i class="fas fa-grip-horizontal"></i> <span>Data Kategori</span></a></li>

              <li><a class="nav-link" href="<?php echo base_url('admin/data_penyewa') ?>"><i class="fas fa-users"></i> <span>Data Penyewa</span></a></li>
